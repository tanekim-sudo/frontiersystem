...
export function createLiveDbClient() {
  ...
  // Only treat genuine Postgres connection strings as "configured". Anything
  // else (empty, "undefined", stray hostnames, sqlite:, etc.) falls back to the
  // seeded demo dataset instead of attempting a doomed DNS lookup.
